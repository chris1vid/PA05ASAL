...
define config.layers = [ 'blackback', 'master', 'icon', 'transient', 'screens', 'overlay']
...
define config.name = _("Purrfect Apawcalypse 0.5: A Stab at Love")
...
define build.name = "PurrfectApawcalypse0.5"
...
define config.main_menu_music = "song-opening.ogg"
...
define config.save_directory = "PurrfectApawcalypse-1543373204"
